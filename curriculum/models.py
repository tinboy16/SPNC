...
class Subject(models.Model):
    ...
    image = models.ImageField(upload_to=save_subject_image, blank=True, verbose_name='Ảnh khóa học')
    description = models.TextField(max_length=500,blank=True)
...
class Lesson(models.Model):
    ...
    position = models.PositiveSmallIntegerField(verbose_name="Bài số")
    slug = models.SlugField(null=True, blank=True)
    video = models.FileField(upload_to=save_lesson_files, verbose_name="Video", blank=True, null=True)
    ppt = models.FileField(upload_to=save_lesson_files, verbose_name="Bài giảng", blank=True)
    Notes = models.FileField(upload_to=save_lesson_files, verbose_name="Ghi chú", blank=True)
